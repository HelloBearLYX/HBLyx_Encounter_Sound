...
L["TextWarningSkinsSettingsDesc"] = "替换暴雪的首领文本警告, 提供自定义选项"
L["PrivateWarningSettings"] = "私有警告"
L["PrivateWarningSettingsDesc"] = "暴雪的私有警告, 与私有光环高度相关, 除了锚点之外由暴雪控制\n\n"
L["PrivateAuraAnchorSettings"] = "减益锚点"
L["PrivateAuraAnchorSettingsDesc"] = "设置减益的锚点，并自定义图标布局"
L["HighlightIconsSettings"] = "高亮图标"
L["HighlightIconsSettingsDesc"] = "为高亮事件(<= 5秒)显示图标"
L["TimelineSkinsSettings"] = "时间轴"
L["TimelineSkinsSettingsDesc"] = "替换暴雪的首领技能时间轴, 提供自定义选项"
L["IconSize"] = "图标大小"
L["Width"] = "宽度"
L["Height"] = "高度"
L["IconZoom"] = "图标缩放"
...
L["TemplateDesc"] = "用于为Boss战事件快速套用设置模板"

-- MARK: Lura Runes
L["AssisstantToBroadcast"] = "通报权限"
L["AssisstantToBroadcastDesc"] = "只有团队领袖和助理有权限通报"
L["LuraHelperSettings"] = "鲁拉助手"
L["UndoLastRune"] = "撤销上一个符文"
L["LuraHelperSettingsDesc"] = "鲁拉首领战的广播助手模块(3183)"
L["LuraHelperInstruction"] = "用户之间的通信高度依赖于聊天频道(/raid和/rw), 这是由于暴雪对插件通信的明确限制\n" ..
