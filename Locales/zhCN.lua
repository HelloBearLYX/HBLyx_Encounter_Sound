...
"v3.14\n" .. "-应用暴雪 03/02/26 私有光环数据更新, 并持续修正数据\n" ..
"v3.13\n" .. "-显著改善用户界面和用户体验\n" ..
"v3.12\n" .. "-完全将BOSS战音效模块从 |cff8788eeHBLyx_Tools|r 中拆分出来, 并作为独立模块 |cff8788eeHBLyx_Encounter_Sound|r\n"
...
L["TimelineSkinsSettings"] = "时间轴皮肤"
L["TimelineSkinsSettingsDesc"] = "自定义暴雪首领技能时间轴的显示样式\n\n你可以在这里调整大小、长度、增长方向、纵向布局、字体和透明度。\n\n"
L["IconSize"] = "图标大小"
L["IconZoom"] = "图标缩放"
L["Length"] = "长度"
L["X"] = "X"
