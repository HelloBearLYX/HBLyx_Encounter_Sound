...
local function CreateContributorPanel(container)
    ...
    RUI:SetText(string.format("|cFF0070DDRUI|r - %s, %s, %s, and %s", L["data correction"], L["testing"], L["feedbacks"], L["configuration sharing"]))
    ...
    RUI:SetCallback("OnEnter", function() RUI:SetText(string.format("|cFFFFFFFFRUI|r - %s, %s, %s, and %s", L["data correction"], L["testing"], L["feedbacks"], L["configuration sharing"])) end)
    RUI:SetCallback("OnLeave", function() RUI:SetText(string.format("|cFF0070DDRUI|r - %s, %s, %s, and %s", L["data correction"], L["testing"], L["feedbacks"], L["configuration sharing"])) end)
    contributorsGroup:AddChild(RUI)
    local XR = AceGUI:Create("InteractiveLabel")
    XR:SetText(string.format("|cFF0070DDXR行而|r - %s and %s", L["configuration sharing"], L["feedbacks"]))
    ...
    XR:SetCallback("OnEnter", function() XR:SetText(string.format("|cFFFFFFFFXR行而|r - %s and %s", L["configuration sharing"], L["feedbacks"])) end)
    XR:SetCallback("OnLeave", function() XR:SetText(string.format("|cFF0070DDXR行而|r - %s and %s", L["configuration sharing"], L["feedbacks"])) end)
