...
local function CreateContributorPanel(container)
    ...
    XR:SetText("|cFF0070DDXR行而|r - configuration sharing and feedbacks")
    ...
    XR:SetCallback("OnEnter", function() XR:SetText("|cFFFFFFFFXR行而|r - configuration sharing and feedbacks") end)
    XR:SetCallback("OnLeave", function() XR:SetText("|cFF0070DDXR行而|r - configuration sharing and feedbacks") end)
