...
addon.data.MAP_ENCOUNTER_EVENTS = {
	...
	[1307] = {
		...
		encounters = {
			...
			[3177] = {
				...
				journalID = 2734,
				privateAuras = {1272527, 1243270, 1241844, 1254113}
			},
			[3179] = {
				events = {140, 143, 148, 141, 142, 139},
				journalID = 2736,
				privateAuras = {1250828, 1245960, 1250991, 1245592, 1251213, 1248697, 1248709, 1250686, 1260030, {1253024, 1268992}, 1271577}
			},
			[3178] = {
	...
	[1308] = {
		...
		encounters = {
			...
			[3183] = {
				events = {632, 259, 261, 364, 256, 434, 363, 437, 435, 362, 255, 433, 258, 636, 260, 405, 263, 262, 436, 650, 649, 644, 257},
				journalID = 2740,
