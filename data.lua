...
addon.data.MAP_ENCOUNTER_EVENTS = {
	...
	[1309] = {
		...
		encounters = {
			...
			["trash"] = {
				privateAuras = {1238084, 1238076, 1237858, 1303039, 1242135, 1251345, 1238368, 1250937}
			},
		},
	},
	-- MARK: MR
	...
	[1313] = {
		...
		encounters = {
			...
			["trash"] = {
				privateAuras = {1267894, 1250043, 1299913, 1249712, 1298899, 1299244, 1299133, 1298917, 1298922, 1298902, 1298903, 1300138, 1233535, 1252406, 1310309}
			},
