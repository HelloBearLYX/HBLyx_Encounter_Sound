	...
	[1304] = {
		...
		encounters = {
			[3101] = {
				...
				journalID = 2679,
				privateAuras = {1228198, {1217633, 1228198}, 1223613, 1253813},
			},
			[3102] = {
				events = {123, 124, 125, 127, 193},
				journalID = 2680,
				privateAuras = {474545, 474740, 1214352, {1216590, 474515}},
			},
			[3103] = {
				events = {30, 31, 32, 753},
				journalID = 2681,
			...
			["trash"] = {
				privateAuras = {1302010, 1295427, 1217973, 1297682, 1216300, 1216074, 1216529, 1216954, 1201554, 1294870, 1215985, 1218187, 1219631, 1216571, 1295035}
			},
		},
	},
	-- MARK: DoN
	[1311] = {
		...
		encounters = {
			...
			[3208] = {
				events = {67, 68, 69, 70},
				journalID = 2777,
				privateAuras = {1235549, 1297749, 1236289, {1266193, 1235841}},
			},
			[3209] = {
				events = {90, 92, 89, 91, 598},
				journalID = 2778,
				privateAuras = {1242869, 1261781, 1297792, 1255577, 1297797, 1243273, 1262253},
			},
			["trash"] = {
				privateAuras = {1239428, 1309964, 1239860, 1241464, 1238439, 1246957, 1247367, 1252825, 1233904, 1238247, 1297701, 1238687, 1246882, 1238801}
			},
		},
	},
	-- MARK: VA
	...
	[1030] = {
		...
		encounters = {
			[2124] = {
				...
				journalID = 2142,
				privateAuras = {1288885, 1308738, 1288457},
			},
			[2125] = {
			...
			[2127] = {
				events = {354, 828},
				journalID = 2145,
				privateAuras = {1300666, 1300684, 1302158, 1303446, 1302618, 1300877, 1302826, 1300704, 1300714},
			},
			["trash"] = {
				privateAuras = {1225638, 1293307, 273274, 1308546, 1296052, 1291468, 1308113, 1308148, 1303596, {1289589, 1293133}, 1303486, 1295635, 1291399, 272655}
			},
		},
	},
	-- MARK: RLP
