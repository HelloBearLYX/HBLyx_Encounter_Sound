	...
	[1320] = {
		...
		encounters = {
			[3470] = { -- Nekzalithe Soulcoiler
				...
				journalID = 2888,
				privateAuras = {1287434, 1289875, 1288554, 1284103, 1307939, 1293214, 1300235, 1299988, 1300239, 1294933, 1284109, 1288772, 1297624, 1292751},
			},
			[3445] = { -- Entombed Sentinels
				order = 2,
				events = {637, 638, 639, 640, 641, 643, 668, 673, 788},
				journalID = 2874,
				privateAuras = {1284500, 1284506, 1284590, 1284947, 1284491, 1288260, 1288297, 1284471},
			},
			...
			[3421] = { -- The Twin Fangs
				order = 6,
				events = {711, 739, 740, 741, 742, 743, 744, 751, 753, 896, 897, 900, 995},
				journalID = 2887,
			...
			[3492] = { -- Ulatek
				...
				journalID = 2895,
				privateAuras = {1298367, 1286860, 1292188, 1286905, 1298559, 1299757, 1300530, 1300751, 1301510, 1302982, 1296301, 1292999, 1295360, 1300938, 1298417, 1311611, 1311609, 1300312, 1300685},
			},
		},
	},
	[1317] = {
